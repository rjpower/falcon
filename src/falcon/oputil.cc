...
const char* OpUtil::name(int opcode) {
  switch (opcode) {
    ...
    case SLICE+1: return "SLICE";
    case SLICE+2: return "SLICE";
    case SLICE+3: return "SLICE";
    case STORE_SLICE: return "STORE_SLICE";
    case STORE_SLICE+1: return "STORE_SLICE";
    case STORE_SLICE+2: return "STORE_SLICE";
    case STORE_SLICE+3: return "STORE_SLICE";
    case DELETE_SLICE: return "DELETE_SLICE";
    case DELETE_SLICE+1: return "DELETE_SLICE";
    case DELETE_SLICE+2: return "DELETE_SLICE";
    case DELETE_SLICE+3: return "DELETE_SLICE";
